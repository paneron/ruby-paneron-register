    ...
    module Raw
      class RegisterRoot
        ...
        def initialize(register_root_path)
          ...
          @register_root_yaml_path = File.join(
            register_root_path,
        ...
        REGISTER_ROOT_METADATA_FILENAME = "/paneron.yaml"
        ...
        def self.validate_root_path(register_root_path)
          ...
          unless File.exist?(
            File.join(register_root_path, REGISTER_ROOT_METADATA_FILENAME),
          )
            raise Paneron::Register::Error,
        ...
        def registries(register_name = nil)
          if register_name.nil?
            ...
            @registries[register_name] ||=
              Paneron::Register::Raw::Register.new(register_root_path,
                                                   register_name)
          end
        end
